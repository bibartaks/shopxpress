...
//   const [selectedPriceRangeLow, setSelectedPriceRangeLow] = useState(null)
//   const [selectedPriceRangeHigh, setSelectedPriceRangeHigh] = useState(null)
//   const [selectedCategory, setSelectedCategory] = useState<string>('')
//   if (priceFilter) {
//     const [minPrice, maxPrice] = priceFilter?.split('-').map(Number)
...
//   const handleApplyPriceChange = () => {
//     if (selectedPriceRangeLow && selectedPriceRangeHigh) {
//       router.push(
//         `?category=${selectedCategory}&price_range=${selectedPriceRangeLow}-${selectedPriceRangeHigh}`
//       )
//     }
...
//               <input
//                 type="number"
//                 // value={highPriceAndlowPrice ? highPriceAndlowPrice[0] : null}
//                 value={
//                   selectedPriceRangeLow
//                     ? selectedPriceRangeLow
//                     : highPriceAndlowPrice
...
//               <input
//                 type="number"
//                 // value={highPriceAndlowPrice ? highPriceAndlowPrice[1] : null}
//                 value={
//                   selectedPriceRangeHigh
//                     ? selectedPriceRangeHigh
//                     : highPriceAndlowPrice
